...
public class SachFragment extends Fragment {
    ...
    private void dialogthemSach(){
        ...
        EditText edt_sLuong = view.findViewById(R.id.ed_them_sLuong);
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                int sLuong = Integer.parseInt(edt_sLuong.getText().toString());

                boolean  check = sachDAO.themSach(maSach, tenSach, tien, maLoai, sLuong);
                if (check){
                    loadData();
